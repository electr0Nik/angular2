...
var mock_memory_data_service_1 = require('./mock-web-api/mock-memory-data.service');
    ...
    AppModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                http_1.HttpModule,
                in_memory_web_api_module_1.InMemoryWebApiModule.forRoot(mock_memory_data_service_1.MockInMemoryDataService)
            ],
            declarations: [
